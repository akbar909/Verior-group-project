...
export default function NotebookDetailPage() {
  ...
  return (
    ...
    <div className="w-full min-h-screen mt-20 md:mt-24 px-4 md:px-8 xl:px-36 2xl:px-64">
      ...
      />
        ...
        {(notebook.id === "1" || notebook.id === "2") ? (
          <>
            <div className="text-black dark:text-white text-base sm:text-lg space-y-4 w-full max-w-4xl mx-auto px-4 sm:px-8 md:px-12 py-6 bg-transparent">
